# Swift 3 Style Guide (draft)

This style guide is based on [The Official raywenderlich.com Swift Style Guide](https://github.com/raywenderlich/swift-style-guide/blob/master/README.markdown).
...
Split system and 3rd party imports with newline.
...
Wrap MARK comments with newline before and after
...
Use capitalized first letter for MARK message
...
Split properties by next rules. Each group separated by newline.
1. Outlets
2. Static constants and variables
3. Properties
4. didSet, willSet, ... observers
...
private static let AAA = 7
private static let DDD = 7
...
Sort properties by increasing access level. Each new level should be separated with newline.
1. private
2. fileprivate
3. internal
4. public
...
#### By let and var keywords

Sort properties by let and var keywords. Each new keyword should be separated with newline.
1. let
2. var
...
Don't split group of properties which marked swiftlint comments with newline
